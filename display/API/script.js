...
function showData() {
    let url = "http://localhost/BE15-CR12-Vladimir/display/displayAll.php";
    ...
    request.onload = function() {
        ...
        for (val of result) {
            ...
            <img src="/BE15-CR12-Vladimir/pictures//${val.picture}" class="card-img-top boximage" alt="${val.name}" width="90px" height="200px">
